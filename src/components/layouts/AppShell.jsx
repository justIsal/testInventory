...
const menuItems = [
 {title: "Dashboard", url: "/pegawai", icon: "/svg/home.svg"},
 {
  title: "Permintaan",
  url: "/pegawai/permintaan",
  icon: "/svg/permintaan.svg",
  subItems: [
   {
    title: "Permintaan Form",
    url: "/pegawai/permintaan/form",
    icon: "/svg/form.svg",
   },
   {
    title: "Permintaan Return",
    url: "/pegawai/permintaan/return",
    icon: "/svg/form.svg",
   },
  ],
 },
 {
  title: "Pengadaan",
  url: "/pegawai/pengadaan",
  icon: "/svg/pengadaan.svg",
  subItems: [
   {
    title: "Form Pengadaan",
    url: "/pegawai/pengadaan/form",
    icon: "/svg/form.svg",
   },
   {
    title: "Form Return",
    url: "/pegawai/pengadaan/return",
    icon: "/svg/form.svg",
   },
  ],
 },
 {title: "List Barang", url: "/pegawai/listBarang", icon: "/svg/list.svg"},
 {title: "Log Barang", url: "/pegawai/log-barang", icon: "/svg/log.svg"},
];
     ...
     <nav className="w-full  mt-2 rounded-xl py-2 px-8  backdrop-saturate-200 backdrop-blur-2xl bg-opacity-80  ">
      <div className="flex items-center justify-between text-blue-gray-900">
       <div className="flex items-center gap-3">
        ...
        <div>
         <Typography variant="h5">{session?.user?.nama}</Typography>
         <Typography>
          {session?.user?.role} - {session?.user?.divisi}
         </Typography>
        </div>
       </div>
