...
import { Card, Typography, CardBody, Button, Tooltip, IconButton } from '@material-tailwind/react';
...
export default function TableLaporanPengadaan({ tableHead, tableRow }) {
  ...
  return (
    <Card className="h-full w-full bg-transparent relative" shadow={false}>
