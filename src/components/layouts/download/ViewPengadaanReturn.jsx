...
export default function ViewPengadaanReturn({ data, dokumentRef, className }) {
  useEffect(() => {
    console.log('data');
    console.log(data);
  }, [data]);
  ...
  return (
    <div className={`w-[1124px] h-[794px] relative ${className} !bg-opacity-0`} ref={dokumentRef}>
              ...
              <table className="mt-4 w-full min-w-max table-auto text-left border-collapse">
                <thead>
                  <tr>
                    ...
                    <th className="border-y border-gray-100 p-2">
                      <Typography className="text-center">Alasan</Typography>
                    </th>
                  </tr>
                </thead>
                <tbody className="">
                  {data && (
                    <tr>
                      ...
                      <td className="p-4 text-black text-center">
                        <Typography>{data.alasan}</Typography>
                      </td>
                    </tr>
                  )}
                </tbody>
