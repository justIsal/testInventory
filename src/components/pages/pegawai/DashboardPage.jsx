     ...
     {dashboar && (
      <>
       <Card className="bg-[#066AFF]/40 w-full text-white">
        ...
        <CardBody>
         <Typography>{dashboar.pengadaan} Pengajuan</Typography>
        </CardBody>
        <CardFooter className="flex justify-end">
         <Button className="bg-[#066AFF]">Buat Pengadaan</Button>
        </CardFooter>
       </Card>
       <Card className="bg-[#066AFF]/40 w-full text-white">
        <CardHeader className="p-4 bg-[#066AFF] text-center">
        ...
        <CardBody>
         <Typography>X Barang dari {dashboar.permintaan}</Typography>
        </CardBody>
        <CardFooter className="flex justify-end">
         <Button className="bg-[#066AFF]">Buat Permintaan</Button>
        </CardFooter>
       </Card>
       <Card className="bg-[#066AFF]/40 w-full text-white">
        <CardHeader className="p-4 bg-[#066AFF] text-center">
        ...
        <CardBody>
         <Typography>X Barang dari {dashboar.barang}</Typography>
        </CardBody>
        <CardFooter className="flex justify-end">
         <Button className="bg-[#066AFF]">Buat Permintaan</Button>
        </CardFooter>
