...
export default function PermintaanReturnPage() {
 const {
  loading: loadingAll,
  response: allBarang,
 ...
 return (
  allBarang && (
   <div>
    {allBarang && console.log(allBarang.map((item) => item["id-barang"]))}
    <CardMain
